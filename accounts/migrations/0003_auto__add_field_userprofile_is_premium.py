...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.is_premium'
        db.add_column(u'accounts_userprofile', 'is_premium',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.is_premium'
        db.delete_column(u'accounts_userprofile', 'is_premium')
